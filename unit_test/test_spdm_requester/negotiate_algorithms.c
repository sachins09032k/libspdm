...
static void libspdm_test_requester_negotiate_algorithms_case1(void **state)
{
    ...
    spdm_context->local_context.algorithm.measurement_hash_algo =
        m_libspdm_use_measurement_hash_algo;
    spdm_context->local_context.algorithm.base_asym_algo = 0x00000fff;  //assuming that the requester supports all the SPDM-enumerated asymmetric key signature algorithms for the purpose of signature verification.
    spdm_context->local_context.algorithm.base_hash_algo = 0x0000007f;  //assuming that the requester supports all the SPDM-enumerated asymmetric key signature algorithms for the purpose of signature verification
